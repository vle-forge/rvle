...
checkEquals(class(notexistingval), "numeric")
...
checkEquals(class(cbis$id5),"list")
...
checkEquals(class(cter$id5),"list")
...
c[1,1] = "hello" # c is a dataframe
rvle.set_condition_port_value(f, "test", "bool",c)
c = rvle.get_condition_port_value(f, "test", "bool")
checkEquals(class(c),"data.frame")
checkEqualsNumeric(dim(c)[[1]],3, tolerance=1e-5)
checkEqualsNumeric(dim(c)[[2]],2, tolerance=1e-5)
checkEquals(names(c)[2],"X2")
checkEquals(c[[3,1]],"3")
rvle.set_condition_port_value(f, "test", "bool",c)
c = rvle.get_condition_port_value(f, "test", "bool")
checkEquals(class(c),"data.frame")
...
checkEquals(names(c)[2],"X2")
checkEquals(c[[3,1]],"3", tolerance=1e-5)
