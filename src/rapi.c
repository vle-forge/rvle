...
r_rvle_onunload();
static SEXP
r_rvle_compile_vle_output();
static SEXP
r_rvle_compile_test_port();
static SEXP
r_rvle_list_packages();
static SEXP
r_rvle_list_content(SEXP pkgname);
static SEXP
r_rvle_open(SEXP name);
static SEXP
r_rvle_pkg_open(SEXP name, SEXP pkg);
static SEXP
r_rvle_run_poly(SEXP rvle, SEXP withSpawn);
static SEXP
r_rvle_run(SEXP rvle, SEXP withSpawn);
static SEXP
r_rvle_run_matrix(SEXP rvle, SEXP withSpawn);
static SEXP
r_rvle_manager_poly(SEXP rvle, SEXP withSpawn);
static SEXP
r_rvle_manager(SEXP rvle, SEXP withSpawn);
static SEXP
r_rvle_manager_matrix(SEXP rvle, SEXP withSpawn);
static SEXP
r_rvle_manager_thread_poly(SEXP rvle, SEXP th, SEXP withSpawn);
static SEXP
r_rvle_manager_thread(SEXP rvle, SEXP th, SEXP withSpawn);
static SEXP
r_rvle_manager_thread_matrix(SEXP rvle, SEXP th, SEXP withSpawn);
static void
r_rvle_delete(SEXP rvle);
static SEXP
r_rvle_condition_list(SEXP rvle);
static SEXP
r_rvle_condition_size(SEXP rvle);
static SEXP
r_rvle_condition_port_list(SEXP rvle, SEXP cnd);
static SEXP
r_rvle_condition_port_list_size(SEXP rvle, SEXP cnd);
static SEXP
r_rvle_condition_show(SEXP rvle, SEXP cnd, SEXP prt);
static void
r_rvle_condition_clear(SEXP rvle, SEXP cnd, SEXP prt);
static void
r_rvle_experiment_set_duration(SEXP rvle, SEXP val);
static SEXP
...
static SEXP
r_rvle_view_size(SEXP rvle);
static void
r_rvle_set_output_plugin(SEXP rvle,
                         SEXP viewname,
                         SEXP pluginname,
                         SEXP package);
static SEXP
r_rvle_get_output_plugin(SEXP rvle, SEXP viewname);
static void
r_rvle_save(SEXP rvle, SEXP file);
// NEW
static void
rvle_addValueCondition(SEXP rvle, SEXP cnd, SEXP prt, SEXP val);
static void
rvle_addView(SEXP rvle, SEXP view);
static void
rvle_removeView(SEXP rvle, SEXP view);
static void
rvle_addObservablePort(SEXP rvle, SEXP obsName, SEXP portName);
static void
rvle_removeObservablePort(SEXP rvle, SEXP obsName, SEXP portName);
static void
rvle_attachView(SEXP rvle, SEXP view, SEXP obsName, SEXP portName);
static void
rvle_detachView(SEXP rvle, SEXP view, SEXP obsName, SEXP portName);
SEXP
rvle_listAttachedViews(SEXP rvle, SEXP obsName, SEXP portName);
SEXP
rvle_getAttachedViewsSize(SEXP rvle, SEXP obsName, SEXP portName);
SEXP
rvle_listObservables(SEXP rvle);
SEXP
rvle_listObservablePorts(SEXP rvle, SEXP obsName);
SEXP
rvle_getObservablesSize(SEXP rvle);
SEXP
rvle_getObservablePortsSize(SEXP rvle, SEXP obsName);
static void
r_rvle_add_condition(SEXP rvle, SEXP cnd);
static void
r_rvle_remove_condition(SEXP rvle, SEXP cnd);
static void
r_rvle_add_port(SEXP rvle, SEXP cnd, SEXP prt);
static void
r_rvle_remove_port(SEXP rvle, SEXP cnd, SEXP prt);
static void
r_rvle_attach_condition(SEXP rvle, SEXP atom, SEXP cnd);
static void
r_rvle_detach_condition(SEXP rvle, SEXP atom, SEXP cnd);
static SEXP
r_rvle_get_config_view(SEXP rvle, SEXP viewname);
static void
r_rvle_set_config_view(SEXP rvle, SEXP viewname, SEXP config);

// DEPRECATED
static void
r_rvle_condition_add_real(SEXP rvle, SEXP cnd, SEXP prt, SEXP val);
static void
r_rvle_condition_add_integer(SEXP rvle, SEXP cnd, SEXP prt, SEXP val);
static void
r_rvle_condition_add_string(SEXP rvle, SEXP cnd, SEXP prt, SEXP val);
static void
r_rvle_condition_add_boolean(SEXP rvle, SEXP cnd, SEXP prt, SEXP val);
static void
r_rvle_condition_add_tuple(SEXP rvle, SEXP cnd, SEXP prt, SEXP values);
...
R_CallMethodDef callMethods[] = {
    ...
    { "run_manager_thread_matrix", (DL_FUNC)r_rvle_manager_thread_matrix, 3 },
    ...
    { "condition_port_list_size",
      (DL_FUNC)r_rvle_condition_port_list_size,
      2 },
    ...
    { "get_output_plugin", (DL_FUNC)r_rvle_get_output_plugin, 2 },
    ...
    { "r_rvle_get_config_view", (DL_FUNC)r_rvle_get_config_view, 2 },
    { "r_rvle_set_config_view", (DL_FUNC)r_rvle_set_config_view, 3 },
    // DEPRECATED
...
r_rvle_list_packages()
{
    int size = rvle_list_packages_size();
    if (size < 0)
        return R_NilValue;

    char** val = rvle_list_packages();
    return rvle_convertCharToSEXP(val, (unsigned int)size);
}

static SEXP
r_rvle_list_content(SEXP pkgname)
{
    int size = rvle_list_content_size(CHAR(STRING_ELT(pkgname, 0)));
    if (size < 0)
        return R_NilValue;
                   ...
                   int withSpawn)
{
    ...
    if (manager) {
        if (nbthreads > 1) {
            result = rvle_manager_thread(
              R_ExternalPtrAddr(rvle), nbthreads, withColNames, withSpawn);
        } else {
            result =
              rvle_manager(R_ExternalPtrAddr(rvle), withColNames, withSpawn);
        }
    } else {
        result = rvle_run(R_ExternalPtrAddr(rvle), withColNames, withSpawn);
    }
    if (!result) {
...
{
    int result =
      rvlecpp_addView(R_ExternalPtrAddr(rvle), CHAR(STRING_ELT(view, 0)));
...
{
    int result =
      rvlecpp_removeView(R_ExternalPtrAddr(rvle), CHAR(STRING_ELT(view, 0)));
    if (!result) {
...
{
    int result =
      rvle_add_condition(R_ExternalPtrAddr(rvle), CHAR(STRING_ELT(cnd, 0)));
    if (!result) {
...
{
    int result =
      rvle_remove_condition(R_ExternalPtrAddr(rvle), CHAR(STRING_ELT(cnd, 0)));
    if (!result) {
...
void
r_rvle_condition_add_tuple(SEXP rvle, SEXP cnd, SEXP prt, SEXP vals)
{
    int len = length(vals);

    if (len <= 0) {
        Rf_error(
          "RVLE: cannot add tuple to condition %s port %s: vals is empty.",
          CHAR(STRING_ELT(cnd, 0)),
          CHAR(STRING_ELT(prt, 0)));
